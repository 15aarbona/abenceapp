...
import { User, Camera, Save, Shield, CreditCard, Phone, Mail, Calendar, Edit3 } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fadeIn">
      <div className="text-center relative">
        <div className="relative inline-block mt-4">
          ...
          <button className="absolute bottom-0 right-0 w-8 h-8 bg-gold rounded-full flex items-center justify-center shadow-lg hover:scale-110 active:scale-95 transition-transform text-black"><Camera size={14} /></button>
        </div>
